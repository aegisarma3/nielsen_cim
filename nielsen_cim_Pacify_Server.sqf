...
_cim_serverFnc = {
	...
	private ["_thisMan","_ace_Cuff","_list_Keycuff"];
	...
	_ace_Cuff = [_thisman,true] call ACE_captives_fnc_setHandcuffed;
	_broadcastedInfo = ["cim_animation",666]call CBA_fnc_publicVariable;
