...
if (isServer) then {
	...
	CIM_Chopper = createVehicle ["B_Heli_Transport_01_F", _spawnPos, [], 0, "NONE"];

	//Spawn crew in chopper
	CIM_HeliGrp = createGroup west;
	_unit = CIM_HeliGrp createUnit ["B_Helipilot_F", _spawnPos, [], 0, "NONE"];
	_unit moveInDriver CIM_Chopper;
	_unit = CIM_HeliGrp createUnit ["B_Helipilot_F", _spawnPos, [], 0, "NONE"];
	_unit moveInCargo [CIM_Chopper,12];
	_unit = CIM_HeliGrp createUnit ["B_helicrew_F", _spawnPos, [], 0, "NONE"];
