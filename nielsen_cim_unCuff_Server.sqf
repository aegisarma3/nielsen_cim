...
private ["_cim_serverFnc","_ace_UnCuff"];
_cim_serverFnc = {
	...
	_ace_UnCuff = [_thisman,false] call ACE_captives_fnc_setHandcuffed;
	_broadcastedInfo = ["cim_animation",777]call CBA_fnc_publicVariable;
